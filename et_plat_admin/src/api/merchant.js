 ...
 * 商户 列表
 */
export function merchantListAddApi(params) {
  return request({
 ...
 * 商户 修改商户密码
 */
export function merchantupdatePasswordApi(data) {
  return request({
    url: `/admin/platform/merchant/update/password`,
    method: 'post',
    data,
  });
}
...
export function menuMerUpdateShowStatus(params) {
  return request({
    url: `/admin/platform/merchant/menu/updateShowStatus`,
    method: 'post',
    params,
  });
}
 ...
 * @param data
 */
export function merHeaderNumApi() {
  return request({
