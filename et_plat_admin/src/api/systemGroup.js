...
export function groupDelete(pram) {
  ...
  return request({
    url: '/admin/platform/group/delete',
    method: 'GET',
    params: data,
  });
}
...
export function groupEdit(pram) {
  ...
  return request({
    url: '/admin/platform/group/update',
    method: 'POST',
    params: data,
  });
}
...
export function goodDesignList(pram) {
  ...
  return request({
    url: '/admin/platform/group/data/list',
    method: 'GET',
    params: data,
  });
}
...
export function themeSave(data) {
  return request({
    url: `/admin/platform/config/saveuniq`,
    method: 'post',
    data,
  });
}
...
export function getTheme(params) {
  return request({
    url: `/admin/platform/config/getuniq`,
    method: 'get',
    params,
  });
}
