    ...
    >
      <div class="table_box">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item>
                  ...
                  />
                  <el-button type="primary" @click="mockData('product')">查询</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
            ...
            <el-table-column label="图片" width="80">
              <template slot-scope="scope">
                <el-image
                  ...
                  lazy
                  :src="$imageUrl(scope.row.imageInput)"
                  fit="fill"
                ...
                ></el-image>
                <el-image style="width: 50px; height: 50px" lazy :src="$imageUrl(scope.row.image)" fit="fill" v-else></el-image>
              </template>
            </el-table-column>
            <el-table-column
              prop="storeName"
        ...
        <div class="right_box" v-if="currenType == 'custom'">
          <div style="width: 440px; margin: 50px 100px 0 0px">
...
<script>
import { productLstApi, productCategoryApi } from '@/api/store';
    ...
    handleSubmit(name) {
      switch (this.currenType) {
        ...
        case 'product_category':
          this.$emit('linkUrl', '/pages/goods_cate/index');
          this.radioData = '';
          break;
        case 'custom':
