    ...
    <el-card class="box-card">
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
        ...
        <el-form-item label="类型" prop="menuType">
          <el-select v-model="queryParams.menuType" placeholder="类型" clearable size="small">
      ...
      >
        <el-table-column prop="name" label="菜单名称" :show-overflow-tooltip="true" min-width="150"></el-table-column>
        ...
        <el-table-column prop="perms" label="权限标识" :show-overflow-tooltip="true" min-width="240"></el-table-column>
        <el-table-column
          prop="component"
          label="组件路径"
          ...
          min-width="200"
        ></el-table-column>
        <el-table-column prop="isShow" label="状态" min-width="80">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" min-width="140">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['platform:merchant:menu:update', 'platform:merchant:menu:info']"
              >修改</el-button
            >
            <el-button
              size="mini"
      ...
      <el-dialog :title="title" :visible.sync="open" width="680px" append-to-body>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button
            type="primary"
            @click="submitForm"
            v-hasPermi="['platform:merchant:menu:add', 'platform:merchant:menu:update']"
            >确 定</el-button
          >
