    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <el-button
          ...
          v-hasPermi="['platform:config:group:save']"
          >添加数据组</el-button
        >
      </div>
      <el-table
        ...
        <el-table-column label="操作" fixed="right" min-width="180">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['platform:config:group:data:list']"
              >数据列表</el-button
            >
            <el-button
              size="small"
              ...
              v-hasPermi="['platform:config:group:data:info', 'platform:config:group:data:update']"
              >编辑</el-button
            >
            <el-button
              size="small"
              ...
              v-hasPermi="['platform:config:group:data:delete']"
              >删除</el-button
            >
          </template>
        </el-table-column>
