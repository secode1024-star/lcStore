  ...
  <div>
    <el-form ref="pram" :model="pram" :rules="rules" label-width="100px" @submit.native.prevent>
      <el-form-item label="管理员账号" prop="account">
        <el-input :disabled="this.isCreate === 1" v-model="pram.account" placeholder="管理员账号" />
      </el-form-item>
      ...
      <el-form-item label="手机号" prop="phone">
        <el-input type="text" v-model="pram.phone" prefix="ios-contact-outline" placeholder="请输入手机号" />
      </el-form-item>
      ...
      <el-form-item>
        <el-button
          ...
          v-hasPermi="['platform:admin:update', 'platform:admin:save']"
