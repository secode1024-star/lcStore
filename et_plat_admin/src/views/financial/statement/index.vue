  ...
  <div class="divBox">
    <el-card class="box-card">
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="small" highlight-current-row>
        ...
        <el-table-column prop="incomeExpenditure" label="平台收支" min-width="100" />
        <el-table-column prop="handlingFee" label="手续费收入" min-width="150" />

        <el-table-column prop="orderPayAmount" label="订单支付总金额" min-width="120" />
        ...
        <el-col :span="21">
          <el-col :span="6">
            <div class="grid-content">
              <span class="title">订单支付总金额</span>
              <span class="color_gray">{{ GLOBAL.shopPayCurrency }}{{ accountDetails.orderPayAmount }}</span>
              <!--<span class="title">支付总订单数</span>-->
              <!--<span class="count">{{ accountDetails.totalOrderNum }}笔</span>-->
              <div class="list">
                <el-row class="item">
                  <el-col :span="12" class="name">总订单支付笔数</el-col>
                  <el-col :span="12" class="cost">
                    <span class="count">{{ accountDetails.totalOrderNum }}笔</span>
                  </el-col>
                </el-row>
                <el-row class="item">
                  <el-col :span="12" class="name">分订单支付笔数</el-col>
                  <el-col :span="12" class="cost">
                    <span class="count">{{ accountDetails.merchantOrderNum }}笔</span>
                  </el-col>
                </el-row>
              </div>
            </div>
          ...
          <el-col :span="6">
            <div class="grid-content">
              <span class="title">平台手续费收入</span>
              <span class="color_gray">{{ GLOBAL.shopPayCurrency }}{{ accountDetails.handlingFee }}</span>
            </div>
            <el-divider direction="vertical" />
          </el-col>
          <el-col :span="6">
            <div class="grid-content">
              ...
              <div class="list">
                <el-row class="item">
                  <el-col :span="12" class="name">商户分账金额</el-col>
                  <el-col :span="12" class="cost">
                    <span class="cost_num"
                      >{{ GLOBAL.shopPayCurrency }}{{ accountDetails.merchantTransferAmount }}</span
                    >
                    <span class="cost_count">{{ accountDetails.merchantTransferNum }}笔</span>
                  </el-col>
                </el-row>
                <el-row class="item">
                  <el-col :span="12" class="name">平台退款金额</el-col>
                  <el-col :span="12" class="cost">
...
// +----------------------------------------------------------------------
import { monthStatementApi, dayStatementApi } from '@/api/financial';
    ...
    handleDelete(id, idx) {
      this.$modalSure().then(() => {
        storeApi.brandDeleteApi(id).then((res) => {
          ...
          localStorage.removeItem('merchantClassify');
          this.$cache.localCache.remove('productBrand');
          this.getList();
        });
      });
    },
