    ...
    <div class="header clearfix">
      <div class="container">
        <el-form inline>
          ...
          <!--<el-form-item label="商品分类：">-->
          <!--<el-cascader v-model="tableFrom.cateId" :options="merProductClassify" :props="props" clearable class="selWidth mr20" @change="getList(1)"/>-->
          <!--</el-form-item>-->
...
<script>
import { productLstApi, productDeleteApi, putOnShellApi, offShellApi, productHeadersApi } from '@/api/store';
