                    ...
                    <span class="el-ic">
                      <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item @click.native="onAdd(data.id)" v-if="checkPermi(['merchant:category:save'])"
                            >添加分类</el-dropdown-item
                          >
                          <el-dropdown-item
                            v-if="
                              node.label !== '全部图片' &&
                              checkPermi(['merchant:category:update', 'merchant:category:info'])
                            "
    ...
    >
      <el-form ref="editPram" :model="editPram" label-width="100px" v-loading="loading">
        ...
        <el-form-item label="排序">
          <el-input-number v-model="editPram.sort" :min="1" :max="9999" />
        </el-form-item>
        <el-form-item>
          <el-button type="primary" :disabled="cateDisabled" @click="handlerSubmit('editPram')">确定</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
  ...
  methods: {
    ...
    categoryChange(e) {
      if (this.cateId == e) {
        ...
        return this.$message.error('不能选择自己');
      } else {
