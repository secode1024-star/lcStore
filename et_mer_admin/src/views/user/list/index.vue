  ...
  <div class="divBox relative">
    <el-card class="box-card">
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="18" :xl="18">
                <el-col v-bind="grid">
                  <el-form-item label="用户昵称：">
                    <el-input v-model="userFrom.keywords" placeholder="请输入用户昵称" clearable class="selWidth" />
                  </el-form-item>
                </el-col>
              </el-col>
      ...
      >
        ...
        <!--&gt;-->
        <!--<template slot-scope="scope">-->
        <!--<span>{{scope.row.lastLoginTime | filterEmpty}}</span>-->
        <!--</template>-->
        <!--</el-table-column>-->
        ...
        <!-- <el-table-column
          ...
          label="余额"
          min-width="100"
          v-if="checkedCities.includes('余额')"
        /> -->
        <!-- <el-table-column
          prop="integral"
          label="积分"
          min-width="100"
          v-if="checkedCities.includes('积分')"
        /> -->
      </el-table>
      <div class="block">
        <el-pagination
