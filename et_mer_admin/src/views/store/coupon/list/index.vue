    ...
    <el-card class="box-card">
        ...
        <div class="container mt-1">
          <el-form inline size="small">
            ...
            <el-form-item label="优惠券名称：">
              <el-input v-model="tableFrom.name" placeholder="请输入优惠券名称" style="width: 350px" clearable>
      ...
      >
        ...
        <el-table-column prop="name" label="领取方式" min-width="100">
          <template slot-scope="{ row }">
            <span>{{ row.type | couponUserTypeFilter }}</span>
          </template>
        </el-table-column>
...
<script>
import { marketingListApi, couponIssueStatusApi, couponUserListApi, couponDeleteApi } from '@/api/store';
