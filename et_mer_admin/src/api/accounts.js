...
export function capitalFlowLstApi(params) {
  return request({
    url: `admin/merchant/finance/monitor/list`,
    method: 'get',
    params,
  });
}
 ...
 * @description 申请转账
 */
export function applyTransferApi(data) {
  return request({
    url: 'admin/merchant/finance/transfer/apply',
    method: 'post',
    data,
  });
}
...
export function transferLstApi(params) {
  return request({
    url: 'admin/merchant/finance/transfer/record/list',
    method: 'GET',
    params,
  });
}
/**
 * @description 获取转账申请基础信息
 */
export function transferBaseInfoApi() {
  return request({
    url: `admin/merchant/finance/transfer/base/info`,
    method: 'GET',
  });
}
...
export function transferDetailApi(id) {
  return request({
    url: `admin/merchant/finance/transfer/record/info/${id}`,
    method: 'GET',
  });
}
