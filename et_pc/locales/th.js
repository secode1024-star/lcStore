...
export default {
	...
	page:{
		...
		goodsDetail:{
			...
			select:'สินค้าที่เลือก',
			clear:'ล้างทั้งหมด',
			settle:'ชำระเงิน',
			num:'จำนวน',
			confirm:'ยืนยัน',
			cancel: 'ยกเลิก',
			assure:"บริการรับประกัน",
			specsInfo:'ข้อมูลคุณสมบัติสินค้า',
			productName:'ชื่อสินค้า',
			material:'วัสดุ/ส่วนประกอบ',
			capacity:'ความจุ',
			origin:'แหล่งกำเนิด',
			size:'ขนาด',
			weight:'น้ำหนัก',
			volume:'ปริมาตร',
			packQuantity:'จำนวนบรรจุ',
			skuLadderPrice:'SKU (ราคาขั้นบันได)',
			default:'ค่าเริ่มต้น',
			spec:'ข้อมูลจำเพาะ',
			color:'สี'
		},
