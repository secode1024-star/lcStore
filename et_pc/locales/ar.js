...
export default {
	...
	page:{
		...
		goodsDetail:{
			...
			choose:'تم الاختيار',
			choose1:'اختيار',
			Reviews:'تقييمات المستخدم',
			good:'تقييم جيد',
			details:'تفاصيل المنتج',
			recommend:'منتجات موصى بها',
			...
			cancel: 'إلغاء',
			assure:"خدمة الضمان",
			specsInfo:'معلومات مواصفات المنتج',
			productName:'اسم المنتج',
			material:'المادة/المكونات',
			capacity:'السعة',
			origin:'بلد المنشأ',
			size:'الحجم',
			weight:'الوزن',
			volume:'الحجم',
			packQuantity:'كمية التعبئة',
			skuLadderPrice:'SKU (السعر المتدرج)',
			default:'افتراضي',
			spec:'المواصفات',
			color:'اللون'
		},
