...
export default {
	...
	page:{
		...
		goodsDetail:{
			...
			choose1:'Sélection',
			Reviews:'Évaluations',
			good:'Bonne évaluation',
			details:'Détails du produit',
			recommend:'Produits recommandés',
			home:'Accueil',
			like:'Favoris',
			cart:'Panier',
			...
			select:'Produits sélectionnés',
			clear:'Tout effacer',
			settle:'Payer',
			num:'Quantité',
			confirm:'Confirmer',
			cancel: 'Annuler',
			assure:"Service de garantie",
			specsInfo:'Spécifications du produit',
			productName:'Nom du produit',
			material:'Matériau/Ingrédients',
			capacity:'Capacité',
			origin:'Origine',
			size:'Taille',
			weight:'Poids',
			volume:'Volume',
			packQuantity:'Quantité d\'emballage',
			skuLadderPrice:'SKU (Prix échelonné)',
			default:'Défaut',
			spec:'Spécification',
			color:'Couleur'
		},
