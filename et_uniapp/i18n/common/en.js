export default {
	...
	page: {
		...
		community: {
			...
			search: 'search',
			noContent: 'no more contents ~',
			toRecommend: 'recommended for you',
			followed: 'Followed',
			toMore: 'Load more',
			like: 'like',
			clickEdit: 'Click to Edit Personalized Signature',
			editSignature: 'Edit Profile',
			cancel: 'cancel',
			save: 'save',
			examineIng: 'Under review',
			examineNo: 'Review failed',
			examineClose: 'Platform shutdown',
			lookExamineNo: 'Check the reason for failure',
			examineAfter: 'After passing, it will be displayed',
			followReturn: 'Return',
			noFollow: 'Not following anyone~',
			noFans: 'No fans~',
			comment: 'comment',
			reply: 'reply',
			delete: 'delete',
			bottom: 'Its over now',
			examineIng2: 'Under review',
			...
			cover: 'cover',
			changeCover: 'Replace the cover',
			addCover: 'Add Cover',
			subject:'subject',
			pleaseSelect:'Please select',
			classification:'classification',
			prohibits:'Platform prohibits comments',
			prohibited:'Is commenting prohibited',
			sure:'sure',
			myAttention:'My attention',
			myFans:'My fans',
			send:'send',
			clickSearch:'Click on search topic',
			Recommended:'Recommended topics',
			allTips:'All topics',
			contentNumber:'contents',
			contentNumberW:'Ten contents',
			hot:'Hot',
			new:'New',
			publish2:'publish',
			share:'share',
			buy:"buy",
			buyNow:'BUY NOW',
			authorBought:'Author Bought',
			retract:'retract',
			expand:'expand',
			Saving:'Saving',
			openSucess:'Successfully opened',
			closeSucess:'Close successfully',
			fol:'fol',
			foled:'foled',
			contentMy:'The content is only visible to oneself'
		}
	},
	message: {
		login: {
		...
		community: {
			loginTips: 'After logging in, you can view~',
			toLogin: 'Login Now',
			logOff: 'Logged out',
			contentTips: 'Please enter the content',
			examineNo: 'Review failed, content is only visible to oneself',
			examineClose: 'Platform closed, content only visible to oneself',
			examineIng: 'Under review, the content is only visible to oneself',
			examineAfter: 'After the content is reviewed and approved, it will be displayed on the homepage!',
			noReply: 'No comments at the moment, hurry up and grab the sofa~',
			titleTips: 'Fill in the title to get more likes~',
			conteneShare1:'Share user experience and insights to gain more likes and attention~(within 600 words)',
			conteneShare2:'Share user experience and insights to gain more likes and attention~(within 200 words)',
			contentvideoTips:'Please add content video',
			contentCategoryTips:'Please select content category',
			coverImage:'Please upload the cover image',
			success:'success',
			sendTips:'Hurry up and say something~',
			covering:'Poster generation in progress'
		}
	},
}