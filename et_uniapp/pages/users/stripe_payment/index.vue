    ...
    <view>
      <form id="payment-form" class="form">
        ...
        <view id="submit" class="button">
          ...
          <span id="button-text" ref="payNow">Pay now</span>
        </view>
 ...
 document.body.appendChild(scripts);
  ...
  let elements;
    export default {
      ...
      methods: {
        initialize(){
          // 此段注释代码为前端自己获取clientSecret值
          // const response = await axios("https://api.beta.adminwm.java.crmeb.net/api/admin/payment/callback/create-payment-intent", {
          //   method: "POST",
        ...
        async handleSubmit(e){
          ...
          const { error } = await stripe.confirmPayment({
           ...
           // Make sure to change this to your payment completion page
              //return_url: process.env.BASE_URL + "/order/payment_result",
              return_url: window.location.origin + "/pages/order_pay_status/index",
            },
          });
