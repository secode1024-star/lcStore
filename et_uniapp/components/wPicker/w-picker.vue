	...
	<view class="w-picker">
		...
		<view class="w-picker-cnt" :class="{'show':showPicker}">
			<view class="w-picker-hd" @touchmove.stop.prevent catchtouchmove="true">
			  <view class="w-picker-btn" @tap="pickerCancel">{{$t(`page.goodsDetail.cancel`)}}</view>
			  <view class="w-picker-btn" :style="{'color':themeColor}" @tap="pickerConfirm">{{$t(`page.goodsDetail.confirm`)}}</view>
			</view>
