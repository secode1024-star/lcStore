			...
			<view class="pic-text acea-row">
				...
				<view class="content">
					<view>
						...
						<view class="sku">{{$t(`page.users.goodsCommentList.attribute`)}}：{{ item.sku?item.sku:'-' }}</view>
					</view>
					...
					<view class="reply" v-if="item.merchantReplyContent">
						<text class="font_color">{{$t(`page.users.goodsCommentList.seller`)}}</text>：{{ item.merchantReplyContent }}
					</view>
				</view>
