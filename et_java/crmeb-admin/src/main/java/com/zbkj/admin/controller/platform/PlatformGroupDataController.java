...
@Slf4j
@RestController
@RequestMapping("api/admin/platform/group/data")
@Api(tags = "设置 -- 组合数据 -- 详情")
public class PlatformGroupDataController {
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:group:data:list')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:group:data:save')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:config:group:data:delete')")
     ...
     * @param request 修改参数
     */
    @PreAuthorize("hasAuthority('platform:config:group:data:update')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:config:group:data:info')")
