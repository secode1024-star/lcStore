...
//     */
//    @PreAuthorize("hasAuthority('merchant:config:save:form')")
...
//     * @param name name
//     */
//    @PreAuthorize("hasAuthority('merchant:config:check')")
...
//     * @param value 对应的值
//     */
//    @PreAuthorize("hasAuthority('merchant:config:saveuniq')")
...
//     * 更新配置信息
//     */
//    @PreAuthorize("hasAuthority('merchant:config:update')")
