...
//            .antMatchers(HttpMethod.OPTIONS, "/**").permitAll()
            ...
            .antMatchers("/api/admin/validate/code/get").permitAll()
            .antMatchers("/api/admin/validate/code/getcaptchaconfig").permitAll()
            .antMatchers("/captcha/**").permitAll()
            .antMatchers("/api/admin/platform/login", "/api/admin/merchant/login").permitAll()
            ...
            .antMatchers("/"+ Constants.DOWNLOAD_TYPE_FILE +"/**").permitAll()
            .antMatchers("/"+ Constants.UPLOAD_TYPE_FILE +"/**").permitAll()
            .antMatchers(
                    HttpMethod.GET,
                    "/*.html",
                    "/**/*.html",
