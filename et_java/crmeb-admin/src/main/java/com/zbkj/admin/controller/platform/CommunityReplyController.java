...
public class CommunityReplyController {
    ...
    public CommonResult<Object> findPageList(@Validated CommunityReplySearchRequest request) {
        return CommonResult.success(CommonPage.restPage(replyService.findPageList(request)));
    }
    ...
    public CommonResult<Object> findNotePageList(@PathVariable("nid") Integer nid, @Validated PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(replyService.findNotePageList(nid, request)));
    }
}
