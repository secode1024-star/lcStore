...
public class StatementTask {
    ...
    public void dailyStatement() {
        // cron : 0 0 0 */1 * ?
        logger.info("---DailyStatementTask dailyStatement------produce Data with fixed rate task: Start Time - {}", DateUtil.nowDateTime());
        try {
        ...
        logger.info("---DailyStatementTask dailyStatement------produce Data with fixed rate task: End Time - {}", DateUtil.nowDateTime());
    }
    ...
    public void monthStatement() {
        // cron : 0 0 2 1 * ?
        logger.info("---DailyStatementTask monthStatement------produce Data with fixed rate task: Start Time - {}", DateUtil.nowDateTime());
        try {
        ...
        logger.info("---DailyStatementTask monthStatement------produce Data with fixed rate task: End Time - {}", DateUtil.nowDateTime());
    }
}
