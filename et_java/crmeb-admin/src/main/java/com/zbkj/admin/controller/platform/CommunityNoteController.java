...
public class CommunityNoteController {
    ...
    public CommonResult<Object> findPageList(@Validated CommunityNoteSearchRequest request) {
        return CommonResult.success(CommonPage.restPage(notesService.findPageList(request)));
    }

    @PreAuthorize("hasAuthority('platform:community:note:detail')")
    @ApiOperation(value = "社区笔记详情")
    @RequestMapping(value = "/detail/{id}", method = RequestMethod.GET)
    public CommonResult<Object> detail(@PathVariable("id") Integer id) {
