...
public class CommunityTopicController {
    ...
    public CommonResult<Object> findPageList(@Validated CommunityTopicSearchRequest request) {
        return CommonResult.success(CommonPage.restPage(topicService.findPageList(request)));
    }
