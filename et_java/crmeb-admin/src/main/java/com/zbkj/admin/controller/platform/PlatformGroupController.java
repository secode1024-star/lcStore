...
@Slf4j
@RestController
@RequestMapping("api/admin/platform/group")
@Api(tags = "平台端设置组合数据")
public class PlatformGroupController {
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:group:list')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:group:save')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:config:group:delete')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:group:update')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:config:group:info')")
