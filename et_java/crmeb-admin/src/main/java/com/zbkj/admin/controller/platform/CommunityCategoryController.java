...
public class CommunityCategoryController {
    ...
    public CommonResult<Object> findPageList(@Validated CommunityCategorySearchRequest request) {
        return CommonResult.success(CommonPage.restPage(communityCategoryService.findPageList(request)));
    }
