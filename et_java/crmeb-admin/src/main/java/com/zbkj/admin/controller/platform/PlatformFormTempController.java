...
@Slf4j
@RestController
@RequestMapping("api/admin/platform/form/temp")
@Api(tags = "平台端设置表单模板")
public class PlatformFormTempController {
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:form:list')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:form:save')")
     ...
     */
    @PreAuthorize("hasAuthority('platform:config:form:update')")
     ...
     * @param id Integer
     */
    @PreAuthorize("hasAuthority('platform:config:form:info')")
