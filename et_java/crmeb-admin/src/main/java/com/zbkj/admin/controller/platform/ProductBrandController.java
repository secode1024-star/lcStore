...
public class ProductBrandController {
    ...
    public CommonResult<PageInfo<ProductBrandListResponse>> getList(@Validated CommonSearchRequest request) {
        return CommonResult.success(productBrandService.getAdminPage(request));
    }
