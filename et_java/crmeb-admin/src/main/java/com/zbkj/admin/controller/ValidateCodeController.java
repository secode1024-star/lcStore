...
//    @PreAuthorize("hasAuthority('admin:validate:code:get')")
    ...
    @ApiOperation(value="是否开启图形验证码")
    @GetMapping(value = "/getcaptchaconfig")
    public CommonResult<Boolean> getCaptchaConfig() {
        return CommonResult.success(crmebConfig.getCaptchaOn());
    }
}
