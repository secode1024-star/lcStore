...
public interface StoreProductReplyService extends IService<StoreProductReply> {
     ...
     * @return PageInfo
     */
    PageInfo<StoreProductReplyResponse> getAdminPage(ProductReplySearchRequest request, PageParamRequest pageParamRequest);
     ...
     * @return PageInfo
     */
    PageInfo<StoreProductReplyResponse> getMerchantAdminPage(ProductReplySearchRequest request, PageParamRequest pageParamRequest);
