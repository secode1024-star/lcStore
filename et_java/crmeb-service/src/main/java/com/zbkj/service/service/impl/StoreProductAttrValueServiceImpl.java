...
public class StoreProductAttrValueServiceImpl extends ServiceImpl<StoreProductAttrValueDao, StoreProductAttrValue>
     ...
     */
    @Override
    public StoreProductAttrValue getByProductIdAndAttrId(Integer productId, Integer attrId, Integer type) {
        ...
        lqw.eq(StoreProductAttrValue::getId, attrId);
    ...
    public Boolean operationStock(Integer id, Integer num, String operationType, Integer type, Integer version) {
        ...
        if (!update) {
            throw new CrmebException(MessageUtils.message("service.storeProductAttrValue.error.a", id));
        }
        return update;
    }
