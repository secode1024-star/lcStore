...
public interface SystemRoleService extends IService<SystemRole> {
     ...
     */
    List<SystemRole> getList(SystemRole request, PageParamRequest pageParamRequest);
     ...
     * @return Boolean
     */
    Boolean add(SystemRole systemRole);
     ...
     */
    Boolean edit(SystemRole systemRoleRequest);
