...
public class SystemUserLevelServiceImpl extends ServiceImpl<SystemUserLevelDao, SystemUserLevel> implements SystemUserLevelService {
    ...
    public Boolean create(SystemUserLevelRequest request) {
        if (request.getGrade().equals(0)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.a")));
        }
        request.setId(null);
        checkLevel(request);
    ...
    private void checkLevel(SystemUserLevelRequest request) {
        ...
        if (ObjectUtil.isNotNull(temp)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.b")));
        }
        // 校验等级级别
        lqw.clear();
        ...
        temp = dao.selectOne(lqw);
        if (ObjectUtil.isNotNull(temp)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.c")));
        }
        ...
        if (request.getGrade() > 1) {
            ...
            if (ObjectUtil.isNotNull(temp) && temp.getExperience() >= request.getExperience()) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.d")));
            }
        }
        lqw.clear();
        ...
        temp = dao.selectOne(lqw);
        if (ObjectUtil.isNotNull(temp) && temp.getExperience() <= request.getExperience()) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.e")));
        }
    }
    ...
    public Boolean edit(SystemUserLevelRequest request) {
        if (ObjectUtil.isNull(request.getId())) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.f")));
        }
        SystemUserLevel level = getById(request.getId());
        if (ObjectUtil.isNull(level) || level.getIsDel()) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.g")));
        }
        if (level.getGrade().equals(0) && !request.getGrade().equals(0)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.h")));
        }
        if (level.getGrade().equals(0) && !request.getExperience().equals(0)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.i")));
        }
        checkLevel(request);
        SystemUserLevel systemUserLevel = new SystemUserLevel();
        BeanUtils.copyProperties(request, systemUserLevel);
    ...
    public Boolean delete(Integer id) {
        ...
        if (ObjectUtil.isNull(level) || level.getIsDel()) {
            throw new CrmebException(SystemConfigResultCode.USER_LEVEL_NOT_EXIST.setMessage(MessageUtils.message("service.systemUserLevel.error.j")));
        }
        if (level.getGrade().equals(0)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.k")));
        }
        level.setIsDel(true);
        return transactionTemplate.execute(e -> {
    ...
    public Boolean updateShow(SystemUserLevelUpdateShowRequest request) {
        ...
        if (level.getGrade().equals(0)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.systemUserLevel.error.l")));
        }
    ...
    public Boolean updateRule(SystemUserLevelRuleRequest request) {
        ...
        if (!update) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.systemUserLevel.error.m")));
        }
        return true;
    }
    ...
    public Boolean updateConfig(SystemUserLevelConfigVo request) {
        ...
        if (!execute) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.systemUserLevel.error.n")));
        }
        return true;
    }
