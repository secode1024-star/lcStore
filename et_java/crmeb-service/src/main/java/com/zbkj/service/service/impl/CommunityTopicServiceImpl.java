...
public class CommunityTopicServiceImpl extends ServiceImpl<CommunityTopicDao, CommunityTopic> implements CommunityTopicService {
    ...
    public void add(CommunityTopicSaveRequest request) {
        if (isExistName(request.getName(), 0)) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_TOPIC_NAME_EXIST.setMessage(MessageUtils.message("service.communityTopic.error.a")));
        }
        ...
        if (!save) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityTopic.error.b")));
        }
    }
    ...
    public void edit(CommunityTopicSaveRequest request) {
        if (ObjectUtil.isNull(request.getId()) || request.getId() <= 0) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_TOPIC_ID_NULL.setMessage(MessageUtils.message("service.communityTopic.error.c")));
        }
        ...
        if (!update) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityTopic.error.d")));
        }
    }
    ...
    public void deleteById(Integer id) {
        ...
        if (!execute) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityTopic.error.e")));
        }
    }
    ...
    public void recommendSwitch(Integer id) {
        ...
        if (topic.getIsHot().equals(0) && getRecommendCount() >= CommunityConstants.COMMUNITY_TOPIC_RECOMMEND_NUM) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_TOPIC_RECOMMEND_NUM.setMessage(MessageUtils.message("service.communityTopic.error.f")));
        }
        topic.setIsHot(topic.getIsHot().equals(1) ? 0 : 1);
        boolean update = updateById(topic);
        if (!update) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityTopic.error.g")));
        }
    }
    ...
    private CommunityTopic getByIdException(Integer id) {
        ...
        if (ObjectUtil.isNull(topic) || topic.getIsDel().equals(1)) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_TOPIC_NOT_EXIST.setMessage(MessageUtils.message("service.communityTopic.error.h")));
        }
        return topic;
    }
