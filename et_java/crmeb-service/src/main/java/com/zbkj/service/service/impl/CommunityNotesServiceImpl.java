...
public class CommunityNotesServiceImpl extends ServiceImpl<CommunityNotesDao, CommunityNotes> implements CommunityNotesService {
    ...
    public void updateTopicIds(Integer id, String topicIds) {
        ...
        if (!update) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.a"));
    ...
    public void audit(CommonAuditRequest request) {
        if (request.getAuditStatus().equals(CommunityConstants.COMMUNITY_NOTE_AUDIT_ERROR) && StrUtil.isBlank(request.getRefusalReason())) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.b")));
        }
        ...
        if (!notes.getAuditStatus().equals(CommunityConstants.COMMUNITY_NOTE_AUDIT_AWAIT)) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_NOTE_AUDIT_STATUS_EXCEPTION.setMessage(MessageUtils.message("service.communityNotes.error.c")));
        }
        ...
        if (!update) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.d"));
        }
    ...
    public void forcedDown(CommonForcedDownRequest request) {
        ...
        boolean update = updateById(notes);
        if (!update) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.e"));
        }
    }
    ...
    public void delete(Integer id) {
        ...
        if (!execute) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.f"));
        }
    }
    ...
    public void updateStar(CommonStarUpdateRequest request) {
        ...
        boolean update = updateById(notes);
        if (!update) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.g"));
        }
    }
    ...
    public void replyForceOffSwitch(Integer id) {
        ...
        boolean update = updateById(notes);
        if (!update) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.h"));
        }
    }
    ...
    public CommunityNotes getByIdException(Integer id) {
        ...
        if (ObjectUtil.isNull(notes) || notes.getIsDel().equals(Constants.COMMON_IS_FILED_ONE)) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_NOTE_NOT_EXIST.setMessage(MessageUtils.message("service.communityNotes.error.i")));
        }
        return notes;
    }
    ...
    public void create(CommunityNoteSaveRequest request) {
        ...
        if (!execute) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.j"));
        }
    ...
    public void updateNote(CommunityNoteSaveRequest request) {
        if (ObjectUtil.isNull(request.getId())) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.k")));
        }
        validatorNoteParam(request);
        Integer userId = userService.getUserIdException();
        CommunityNotes note = getByIdException(request.getId());
        if (!note.getUid().equals(userId)) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.l"));
        }
        ...
        if (!execute) {
            throw new CrmebException(MessageUtils.message("service.communityNotes.error.m"));
        }
    }
    ...
    public PageInfo<CommunityNotes> findDiscoverNoteRecommendList(Integer noteId, PageParamRequest request) {
        ...
        lqw.ne(CommunityNotes::getId, noteId);
    ...
    private void validatorNoteParam(CommunityNoteSaveRequest request) {
        if (CommunityConstants.COMMUNITY_NOTE_TYPE_IMAGE_CONTENT.equals(request.getType())) {
            if (StrUtil.isBlank(request.getImage())) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.n")));

            }
            String[] split = request.getImage().split(",");
            if (split.length > 9) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.o")));
            }
            if (StrUtil.isNotBlank(request.getContent()) && request.getContent().length() > 600) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.p")));
            }

        }
        if (CommunityConstants.COMMUNITY_NOTE_TYPE_SHORT_VIDEO.equals(request.getType())) {
            if (StrUtil.isBlank(request.getVideo())) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.q")));
            }
            if (StrUtil.isNotBlank(request.getContent()) && request.getContent().length() > 200) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.r")));
            }
        ...
        if (StrUtil.isNotBlank(request.getTopicIds())) {
            ...
            if (topicSplit.length > 5) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.s")));
            }
        }
        if (StrUtil.isNotBlank(request.getProIds())) {
            String[] proSplit = request.getProIds().split(",");
            if (proSplit.length > 5) {
                throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityNotes.error.t")));
            }
        }
    }
}
