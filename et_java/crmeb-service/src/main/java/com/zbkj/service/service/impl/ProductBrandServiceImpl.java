...
public class ProductBrandServiceImpl extends ServiceImpl<ProductBrandDao, ProductBrand> implements ProductBrandService {
     ...
     */
    @Override
    public PageInfo<ProductBrandListResponse> getAdminPage(CommonSearchRequest request) {
        Page<ProductBrand> page = PageHelper.startPage(request.getPage(), request.getLimit());
        ...
        if (StrUtil.isNotBlank(request.getKeywords())) {
            ...
            lqw.like(ProductBrand::getName, keywords);
        }
    ...
    public Boolean add(ProductBrandRequest request) {
        ...
        brand.setId(null);
        if (StrUtil.isNotEmpty(brand.getIcon())) {
    ...
    public Boolean delete(Integer id) {
        ...
        if (productService.isUseBrand(brand.getId())) {
            throw new CrmebException(MessageUtils.message("service.productBrand.error.a"));
        }
        brand.setIsDel(true);
        Boolean execute = transactionTemplate.execute(e -> {
            updateById(brand);
    ...
    public Boolean edit(ProductBrandRequest request) {
        if (ObjectUtil.isNull(request.getId())) {
            throw new CrmebException(MessageUtils.message("service.productBrand.error.b"));
        }
    ...
    private ProductBrand getByIdException(Integer id) {
        ...
        if (ObjectUtil.isNull(brand) || brand.getIsDel()) {
            throw new CrmebException(MessageUtils.message("service.productBrand.error.c"));
        }
        return brand;
    }
    ...
    private void validateName(String name) {
        ...
        if (ObjectUtil.isNotNull(brand)) {
            throw new CrmebException(MessageUtils.message("service.productBrand.error.d"));
        }
    }
}
