...
public class CommunityReplyServiceImpl extends ServiceImpl<CommunityReplyDao, CommunityReply> implements CommunityReplyService {
    ...
    public void audit(CommonAuditRequest request) {
        if (request.getAuditStatus().equals(CommunityConstants.COMMUNITY_REPLY_AUDIT_ERROR) && StrUtil.isBlank(request.getRefusalReason())) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityReply.error.a")));
        }
        ...
        if (!reply.getAuditStatus().equals(CommunityConstants.COMMUNITY_REPLY_AUDIT_AWAIT)) {
            throw new CrmebException(CommunityResultCode.COMMUNITY_REPLY_AUDIT_STATUS_EXCEPTION.setMessage(MessageUtils.message("service.communityReply.error.b")));
        }
        ...
        if (!update) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityReply.error.c")));
        }
    ...
    public void delete(Integer id) {
        ...
        if (!execute) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityReply.error.d")));
        }
    ...
    public void likeReply(Integer replyId, Integer userId) {
        ...
        if (ObjectUtil.isNotNull(replyLike)) {
            ...
            if (!remove) {
                throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityReply.error.e")));
            }
        ...
        if (!save) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityReply.error.f")));
        }
    ...
    public CommunityCommentReplyResponse create(CommunityReplyAddRequest request) {
        ...
        if (!save) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityReply.error.g")));
        }
        if (reply.getAuditStatus().equals(CommunityConstants.COMMUNITY_REPLY_AUDIT_SUCCESS)) {
            asyncService.noteAddReplyAfter(reply.getNoteId(), reply.getParentId(), reply.getId());
        }
