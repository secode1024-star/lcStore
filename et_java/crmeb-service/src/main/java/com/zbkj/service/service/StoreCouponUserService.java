...
public interface StoreCouponUserService extends IService<StoreCouponUser> {
     ...
     * @return PageInfo
     */
    PageInfo<StoreCouponUserResponse> getPageList(StoreCouponUserSearchRequest request, PageParamRequest pageParamRequest);
     ...
     */
    PageInfo<UserHaveCouponResponse> getHaveCouponsByUid(Integer uid, PageParamRequest pageParamRequest);
