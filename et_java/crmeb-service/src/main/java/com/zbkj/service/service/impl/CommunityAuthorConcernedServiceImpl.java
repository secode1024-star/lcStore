...
public class CommunityAuthorConcernedServiceImpl extends ServiceImpl<CommunityAuthorConcernedDao, CommunityAuthorConcerned> implements CommunityAuthorConcernedService {
    ...
    public void concernedAuthor(Integer authorId, Integer userId) {
        if (authorId.equals(userId)) {
            throw new CrmebException(CommonResultCode.VALIDATE_FAILED.setMessage(MessageUtils.message("service.communityAuthorConcerned.error.a")));
        }
        ...
        if (ObjectUtil.isNotNull(concerned)) {
            ...
            if (!remove) {
                throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityAuthorConcerned.error.b")));
            }
            return;
        }
        ...
        if (!save) {
            throw new CrmebException(CommonResultCode.ERROR.setMessage(MessageUtils.message("service.communityAuthorConcerned.error.c")));
        }
    }
