...
public final class DateUtil {
    ...
    public static String getYesterdayStr() {
        ...
        SimpleDateFormat startSdf = new SimpleDateFormat(DateConstants.DATE_FORMAT);
    ...
    public static String getWeekStartDay() {
        ...
        SimpleDateFormat startSdf = new SimpleDateFormat(DateConstants.DATE_FORMAT_START);
        return startSdf.format(c.getTime());
    }
        ...
        if(!StringUtils.isBlank(data)){
            switch (data){
                ...
                case DateConstants.SEARCH_DATE_YEAR:
                    ...
                    endTime = DateUtil.nowDateTime(DateConstants.DATE_FORMAT_YEAR_END);
                    break;
...
//                    if (startTime.equals(endTime)) {
                        startTime = DateUtil.appointedDayStrToFormatStr(startTime, DateConstants.DATE_FORMAT_DATE, DateConstants.DATE_FORMAT_START);
                        endTime = DateUtil.appointedDayStrToFormatStr(endTime, DateConstants.DATE_FORMAT_DATE, DateConstants.DATE_FORMAT_END);
//                    }
                    break;
            }
        }
    ...
    public static List<String> getListDate(String data) {
        ...
        //开始日期
        Date startDate = DateUtil.strToDate(dateLimit.getStartTime(), DateConstants.DATE_FORMAT);

        //结束日期
        Date endDate = DateUtil.strToDate(dateLimit.getEndTime(), DateConstants.DATE_FORMAT);

        while (endDate.after(startDate)){
            date.add(DateUtil.dateToStr(startDate, DateConstants.DATE_FORMAT_DATE)); // 放入集合
            startDate = DateUtil.strToDate(DateUtil.addDay(startDate, 1, DateConstants.DATE_FORMAT), DateConstants.DATE_FORMAT); //循环一次 加一天
        }
