...
public class ExportUtil {
    ...
    public static String exportExecl(String fileName, String title, List<?> voList, LinkedHashMap<String, String> aliasMap) {
        if (StrUtil.isBlank(fileName)) {
            throw new CrmebException(MessageUtils.message("common.export.error.a"));
        }
        if (StrUtil.isBlank(title)) {
            throw new CrmebException(MessageUtils.message("common.export.error.b"));
        }
        if (CollUtil.isEmpty(voList)) {//
            throw new CrmebException(MessageUtils.message("common.export.error.c"));
        }
        if (CollUtil.isEmpty(aliasMap)) {
            throw new CrmebException(MessageUtils.message("common.export.error.d"));
        }
...
//        ExcelWriter writer = ExcelUtil.getWriter("d:/writeMapTest.xlsx");
    ...
    public static void setUpload(String rootPath, String modelPath, String type) {
        if (StrUtil.isBlank(rootPath) || StrUtil.isBlank(modelPath) || StrUtil.isBlank(type)) {
            throw new CrmebException(MessageUtils.message("common.export.error.e"));
        }
