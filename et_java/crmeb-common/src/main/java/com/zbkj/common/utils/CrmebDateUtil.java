        ...
        if (StrUtil.isNotBlank(data)) {
            switch (data) {
                ...
                default:
                    ...
                    if (list.size() == 1) {
                        throw new CrmebException(MessageUtils.message("common.crmebDate.error.a",DateConstants.SEARCH_DATE_DAY,
                                DateConstants.SEARCH_DATE_YESTERDAY,DateConstants.SEARCH_DATE_LATELY_7, DateConstants.SEARCH_DATE_LATELY_30 ,
                                DateConstants.SEARCH_DATE_MONTH ,DateConstants.SEARCH_DATE_YEAR ));
                    }
...
//                    }
    ...
    public static dateLimitUtilVo getMonthLimit(String data) {
        ...
        if (monthList.size() != 2) {
            throw new CrmebException(MessageUtils.message("common.crmebDate.error.b"));
        }
        String startMonth = monthList.get(0);
        String endMonth = monthList.get(1);
        if (!isValidMonth(startMonth) || !isValidMonth(endMonth)) {
            throw new CrmebException(MessageUtils.message("common.crmebDate.error.c"));
        }
