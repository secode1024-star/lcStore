...
public class CrmebUtil {
    ...
    public static String encryptPassword(String pwd, String key) {
        try {
            ...
            throw new CrmebException("Password handling exception");
        }
    }
    ...
    public static void main(String[] args) throws Exception {
       // System.out.println(encryptPassword("123456", "18292417675"));
        System.out.println(decryptPassowrd("1x5VSCLZa1qgz84T8EXfeA==", "19142405862"));
    }
    ...
    public static List<Integer> stringToArrayByRegex(String str, String regex) {
        ...
        return Arrays.stream(str.split(regex)).filter(StrUtil::isNotBlank).map(Integer::valueOf).collect(Collectors.toList());
    }
    ...
    public static List<String> stringToArrayStr(String str) {
        return Arrays.stream(str.split(",")).map(String::valueOf).collect(Collectors.toList());
    }
    ...
    public static List<String> stringToArrayStrRegex(String str, String regex) {
        return Arrays.stream(str.split(regex)).map(String::valueOf).collect(Collectors.toList());
    }
