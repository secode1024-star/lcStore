...
public class UserAddressController {
    ...
    public CommonResult<PageInfo<UserAddress>> getList(PageParamRequest pageParamRequest) {
     ...
     * 根据用户Ip获取地址信息
     */
    @ApiOperation(value = "根据用户Ip获取地址信息")
    @RequestMapping(value = "/ip/info", method = RequestMethod.POST)
    public CommonResult<JSONObject> ipInfo(HttpServletRequest request) {
        return CommonResult.success(userAddressService.ipInfo(request));
    }
}
