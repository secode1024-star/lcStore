...
public class CommunityNoteController {
    ...
    public CommonResult<CommonPage<CommunityNoteFrontPageResponse>> findDiscoverNoteList(@ModelAttribute @Validated CommunityNoteFrontDiscoverRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findDiscoverNoteList(request)));
    }

    @ApiOperation(value = "社区笔记关注列表")
    @RequestMapping(value = "/follow/list", method = RequestMethod.GET)
    public CommonResult<CommonPage<CommunityNoteFrontFollowResponse>> findFollowNoteList(@ModelAttribute @Validated PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findFollowNoteList(request)));
    }

    @ApiOperation(value = "社区笔记作者列表")
    @RequestMapping(value = "/author/list/{authorId}", method = RequestMethod.GET)
    public CommonResult<CommonPage<CommunityNoteFrontPageResponse>> findAuthorNoteList(@PathVariable("authorId") Integer authorId, PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findAuthorNoteList(authorId, request)));
    }

    @ApiOperation(value = "社区用户笔记详情")
    @RequestMapping(value = "/user/detail/{noteId}", method = RequestMethod.GET)
    public CommonResult<CommunityNoteFrontDetailResponse> getUserNoteDetail(@PathVariable("noteId") Integer noteId) {
        return CommonResult.success(communityFrontService.getUserNoteDetail(noteId));
    }

    @ApiOperation(value = "社区笔记评论列表")
    @RequestMapping(value = "/reply/list/{noteId}", method = RequestMethod.GET)
    public CommonResult<CommonPage<CommunityCommentReplyResponse>> findNoteReplyPageList(@PathVariable("noteId") Integer noteId, PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findNoteReplyPageList(noteId, request)));
    }

    @ApiOperation(value = "社区话题笔记列表")
    @RequestMapping(value = "/topic/list", method = RequestMethod.GET)
    public CommonResult<CommonPage<CommunityNoteFrontPageResponse>> findTopicNoteList(@Validated CommunityNoteTopicSearchRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findTopicNoteList(request)));
    }

    @ApiOperation(value = "社区笔记发现推荐列表")
    @RequestMapping(value = "/discover/list/recommend/{noteId}", method = RequestMethod.GET)
    public CommonResult<CommonPage<CommunityNoteFrontDetailResponse>> findDiscoverNoteRecommendList(@PathVariable("noteId") Integer noteId, PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findDiscoverNoteRecommendList(noteId, request)));
    }
    ...
    public CommonResult<CommonPage<CommunityNoteFrontPageResponse>> findMyNoteList(PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findMyNoteList(request)));
    }
    ...
    public CommonResult<CommunityCommentReplyResponse> replyAdd(@RequestBody @Validated CommunityReplyAddRequest request) {
        return CommonResult.success(communityFrontService.replyAdd(request));
    }
    ...
    public CommonResult<CommonPage<CommunityNoteFrontPageResponse>> findMyLikeNoteList(PageParamRequest request) {
        return CommonResult.success(CommonPage.restPage(communityFrontService.findMyLikeNoteList(request)));
    }

    @ApiOperation(value = "获取社区笔记评论平台开关设置")
    @RequestMapping(value = "/reply/platform/switch/config", method = RequestMethod.GET)
    public CommonResult<String> getPlatformSwitchConfig() {
        return CommonResult.success(ExceptionCodeEnum.SUCCESS.getCode(),ExceptionCodeEnum.SUCCESS.getMessage(),communityFrontService.getPlatformSwitchConfig());
    }
